...
внешних JS модулей. Эти методы могут манипулировать статическими свойствами, равно
как и содержать произвольный JS код. Для входа в GPU контекст используются операции
...
в их определении присутствует код. Для статических методов не указываются типы
возвращаемых значений и принимаемых параметров.
...
указанный класс или любой его наследник. В статические методы, по понятным соображениям,
...
* Статические методы могут вызывать друг друга непосредственно.
